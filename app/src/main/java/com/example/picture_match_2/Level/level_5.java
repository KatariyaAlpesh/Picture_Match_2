...
import com.example.picture_match_2.Adapter.Picture_Adapter5;
...
public class level_5 extends AppCompatActivity implements Myinterface5
{

    SeekBar seekBar;
    GridView gridView;
    ArrayList<String> arrayListImage5;
...
//////  This is for DialogBox.
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        gridView = findViewById(R.id.Gridvie5);
    ...
    //  Second 30 Second Handler
        ...
        try {
            ...
            arrayListImage5 = new ArrayList<>(Arrays.asList(Image));

            ImageList = arrayListImage5.subList(0 , 10);
            ImageList.addAll(ImageList);
            Collections.shuffle(ImageList);

            Picture_Adapter5 picture_adapter5 = new Picture_Adapter5(this , arrayListImage5);
            gridView.setAdapter(picture_adapter5);
...
////////------>>>    Implements Myinterface5 on top of Program  ==  and get this Override Method


    @Override
    public void Display5(ImageView v, int position)
    {
...
//
                if (arrayListImage5.get(ClickedPositionOne).equals(arrayListImage5.get(ClickedPositionTwo)))
                {
    ...
    public void Win()
    {
        dialogWin = new Dialog(level_5.this);
        ...
        dialogWin.findViewById(R.id.Back).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent IBack;
                IBack = new Intent(level_5.this , NoTimeLimit_Page.class);
                startActivity(IBack);
        ...
        dialogWin.findViewById(R.id.Next).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent INext;
                INext = new Intent(level_5.this , level_6.class);
                startActivity(INext);
    ...
    public void Loss()
    {
        dialogLoss = new Dialog(level_5.this);
        ...
        dialogLoss.findViewById(R.id.ReStart).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent IRestart;
                IRestart = new Intent(level_5.this , level_5.class);
